<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:90:"D:\phpStudy\PHPTutorial\WWW\month12\charge\public/../application/demo\view\index\show.html";i:1526379708;s:83:"D:\phpStudy\PHPTutorial\WWW\month12\charge\application\demo\view\layout\layout.html";i:1526379708;s:83:"D:\phpStudy\PHPTutorial\WWW\month12\charge\application\demo\view\layout\header.html";i:1526379708;s:83:"D:\phpStudy\PHPTutorial\WWW\month12\charge\application\demo\view\layout\footer.html";i:1526379708;}*/ ?>
<base href="/demo/" />
<!doctype html>
<html>
<head>
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">站点管理</span></div>
        </div>
                        ...
                        <?php if(is_array($res) || $res instanceof \think\Collection || $res instanceof \think\Paginator): if( count($res)==0 ) : echo "" ;else: foreach($res as $key=>$v): ?>
	                        <tr>
	                            ...
	                            <td>
	                            	<?php if(($v['c_state']==0)): ?>
	                            	可用
	                            	<?php elseif(($v['c_state']==1)): ?>
	                            	不可用
	                            	<?php elseif(($v['c_state']==2)): ?>
	                            	故障
	                            	<?php endif; ?>
	                            </td>
	                            <td>
	                            	<?php if(($v['c_status']==1)): ?>
	                            	<a href="<?php echo url("index/status"); ?>?id=<?php echo $v['c_id']; ?>">未审核</a>
	                            	<?php else: ?>
	                            	审核通过
	                            	<?php endif; ?>
	                            </td>
	                            ...
	                            <td>
	                                <a class="link-del" href="<?php echo url('index/del'); ?>?id=<?php echo $v['c_id']; ?>">删除</a>
	                            </td>
	                        </tr>
