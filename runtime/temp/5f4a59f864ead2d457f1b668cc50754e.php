<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"D:\www\wamp\www\charge\public/../application/index\view\account\show_bill.html";i:1526382544;s:64:"D:\www\wamp\www\charge\application\index\view\layout\layout.html";i:1526255302;s:64:"D:\www\wamp\www\charge\application\index\view\layout\header.html";i:1526304797;s:64:"D:\www\wamp\www\charge\application\index\view\layout\footer.html";i:1526367682;}*/ ?>
...
<div class="container" id="container">
	...
	<div>
		...
		<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
			<li>
				<h2>
				<?php switch($v['way']): case "1": ?>充值<?php break; case "2": ?>提现<?php break; case "3": ?>在线支付<?php break; case "4": ?>积分兑换<?php break; default: ?>默认情况
				<?php endswitch; ?>
				<span style="font-size: 16px;color: #888;display: inline;">
					<?php echo date("Y-m-d H:i:s",$v['actime']); ?>
				</span>
				</h2>
