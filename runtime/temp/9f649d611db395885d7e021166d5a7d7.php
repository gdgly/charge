<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"D:\www\wamp\www\charge\public/../application/index\view\integral\recharge.html";i:1526367683;s:64:"D:\www\wamp\www\charge\application\index\view\layout\layout.html";i:1526255302;s:64:"D:\www\wamp\www\charge\application\index\view\layout\header.html";i:1526304797;s:64:"D:\www\wamp\www\charge\application\index\view\layout\footer.html";i:1526367682;}*/ ?>
...
<h1>账户充值</h1>
<a href="account_details.html" style="padding-right: 20px;"><span>账户明细</span></a>
</header>
<div class="container" id="container">
	<form action="integral/recharge" method="post">
		<div class="registered">
			<div class="field">
				<span style="font-size: 30px;">银行卡号</span>
				
				<select name="card_id" style="font-size: 15px;">
					<?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$v): ?>
						
						<option value="<?php echo $v['card_id']; ?>" <?php if($v['card_status']==1) echo 'selected';?>>
							<?php echo $v['card_num']; ?>
						</option>
	       	...
	       	<div class="field">
	       		<span style="font-size: 30px;">金额(¥)</span>
	        	<input type="text" name="money" placeholder="请填写充值金额" value="" style="font-size: 15px;">
	       	</div>
