<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"D:\wamp\wamp\www\mouth12\charge\public/../application/index\view\now\now.html";i:1526378008;s:73:"D:\wamp\wamp\www\mouth12\charge\application\index\view\layout\layout.html";i:1526378008;s:73:"D:\wamp\wamp\www\mouth12\charge\application\index\view\layout\header.html";i:1526378008;s:73:"D:\wamp\wamp\www\mouth12\charge\application\index\view\layout\footer.html";i:1526378008;}*/ ?>
  ...
  <form action="<?php echo url('index/now/charging'); ?>" method="post">
    ...
    <ul>
    	<li><space>充电时长</space></li>
			...
			<?php foreach($dur as $vo): if($vo['d_name'] == '充满'): ?> 
					<li><input type="radio" checked="checked" name="time" class="type" value="<?php echo $vo['d_name']; ?>" d_id="<?php echo $vo['d_id']; ?>"/><label><?php echo $vo['d_name']; ?></label><space class="add-space <?php echo $vo['d_id']; ?>"></space></li>
				<?php else: ?> 
					<li><input type="radio" name="time" class="type" value="<?php echo $vo['d_name']; ?>" d_id="<?php echo $vo['d_id']; ?>"/><label><?php echo $vo['d_name']; ?></label><space class="add-space <?php echo $vo['d_id']; ?>"></space></li>
